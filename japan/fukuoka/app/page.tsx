...
import TravelNavigation from '@/japan/fukuoka/components/travel-navigation';
import { SidebarProvider } from '@/japan/fukuoka/components/ui/sidebar';
import DayRouteMap from '@/japan/fukuoka/components/day-route-map';
import PlacesMap, { type MapFocus } from '@/japan/fukuoka/components/places-map';
import PlacePhoto from '@/japan/fukuoka/components/place-photo';
import {
  alternativeHotels,
  hotelMapPlaces,
  foodMapPlaces,
} from '@/japan/fukuoka/lib/place-data';
import {
  Tabs,
  TabsList,
  TabsTrigger,
  TabsContent,
} from '@/japan/fukuoka/components/ui/tabs';
import {
  Table,
  TableHeader,
  TableBody,
  ...
  TableCaption,
  TableRow,
} from '@/japan/fukuoka/components/ui/table';
import {
  Compass,
  Globe2,
  CalendarDays,
