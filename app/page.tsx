...
const directions = (from: string, to: string, mode = 'driving') =>
  ...
  mode;
const sections = [
  ['journey', '每日', '行程', CalendarDays],
  ['stays', '住', '酒店', BedDouble],
  ['food', '吃', '美食', Utensils],
  ['transport', '行', '交通', TrainFront],
  ['essentials', '行前', '锦囊', Backpack],
] as const;
function Out({
  href,
  children,
    ...
    <>
      ...
      <header className="topbar">
        <a href="#top" className="brand">
          <Compass />
          <span>
            九州慢旅<small>KYUSHU · FAMILY JOURNAL</small>
          </span>
        </a>
        <nav aria-label="主要导航">
          {sections.map(([id, , full, Icon]) => (
            <a key={id} href={'#' + id}>
              <Icon size={16} />
              {full}
            </a>
        ...
        <span className="date-label">2026.09.25 — 10.01</span>
      </header>
      <main className="page" id="top">
        <div className="intro">
          <div>
            <span className="eyebrow">7 DAYS / 6 NIGHTS / 3 CITIES</span>
            <h1>把九州，慢慢走一遍。</h1>
            <p>
              福冈的日常，由布院的私汤，别府的惊喜。
              <br />和 8 岁的孩子一起，把时间留给喜欢的事。
            </p>
          ...
          <figure className="cover">
            ...
            />
            <figcaption>
              由布院 · 金鳞湖 <MapPin size={12} />
            </figcaption>
          </figure>
        </div>
        <div className="route-strip" aria-label="住宿路线示意，非按地理比例">
          <span>
            福冈 <b>9/25–27 · 2 晚</b>
          </span>
          <i>→</i>
          ...
          <div className="transport-note">
            ...
            <div>
              ...
              <p>
                ...
                查询；不要仅凭“有两次火车”就默认 JR Pass 更省。8 岁孩子选儿童票
                / 小学生类别。包车另询含等待的总价。
              </p>
            </div>
          </div>
              ...
              <Table>
                ...
                <TableBody>
                  <TableRow>
                    ...
                    <TableCell>
                      <Out href={sources.marineTickets}>普通入馆，体验另计</Out>
                    </TableCell>
                  </TableRow>
                  <TableRow>
                  ...
                  <TableRow>
                    ...
                    <TableCell colSpan={2}>住客使用费包含在住宿费内</TableCell>
                    <TableCell>
        ...
        <footer className="footer">
          ...
          <p className="photo-credit">
            金鳞湖摄影：
            <a
              href="https://commons.wikimedia.org/wiki/File:Kinrin_Lake_-_panoramio.jpg"
              target="_blank"
              rel="noreferrer"
            >
              Nagono / Wikimedia Commons
            </a>{' '}
            ·{' '}
            <a
